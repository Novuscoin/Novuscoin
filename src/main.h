...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 NOV
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 NOV mininput
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 5760 / 250; // 5760 Blocks found a day.
    }
